                ...
                <div class="dropdown relative ml-auto sm:ml-0">
                    ...
                    <div class="dropdown-box mt-10 absolute w-40 top-0 right-0 z-20">
                        <div class="dropdown-box__content box p-2">                       
                            <a href="<?=site_url('skck/excel')?>" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="file-plus" class="w-4 h-4 mr-2"></i> Excel </a>
                            <a href="<?=site_url('skck/word')?>" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="file-plus" class="w-4 h-4 mr-2"></i> Word </a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    columns: [
                        ...
                        },{"data": "nik"},{"data": "nama"},{"data": "tujuan"},{"data": "status"}
                    ],
                    order: [[0, 'desc']],
