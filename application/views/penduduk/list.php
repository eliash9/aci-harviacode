                    ...
                    <div class="intro-x relative mr-3 sm:mr-6">
                        ...
                        <div class="search-result">
                            <div class="search-result__content">
                                ...
                                <div class="mb-5">
                                    <a href="" class="flex items-center mt-2">
                                        <div class="w-8 h-8 image-fit">
                                            <img alt="img" class="rounded-full" src="dist/images/profile-10.jpg">
                                        </div>
                                    ...
                                    <a href="" class="flex items-center mt-2">
                                        <div class="w-8 h-8 image-fit">
                                            <img alt="img" class="rounded-full" src="dist/images/profile-4.jpg">
                                        </div>
                                        <div class="ml-3">Johnny Depp</div>
                                        <div class="ml-auto w-48 truncate text-gray-600 text-xs text-right">johnnydepp@left4code.com</div>
                                    </a>
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="img" class="rounded-full" src="dist/images/preview-7.jpg">
                                    </div>
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="img" class="rounded-full" src="dist/images/preview-5.jpg">
                                    </div>
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="img" class="rounded-full" src="dist/images/preview-10.jpg">
                                    </div>
                            ...
                            <tbody>
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 17 July 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 17 July 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-10.jpg" title="Uploaded at 17 July 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 26 November 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 26 November 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-1.jpg" title="Uploaded at 26 November 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-14.jpg" title="Uploaded at 27 April 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-2.jpg" title="Uploaded at 27 April 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 27 April 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-1.jpg" title="Uploaded at 13 October 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-8.jpg" title="Uploaded at 13 October 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-8.jpg" title="Uploaded at 13 October 2020">
                                            </div>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-7.jpg" title="Uploaded at 23 October 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-2.jpg" title="Uploaded at 23 October 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 23 October 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 23 April 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-10.jpg" title="Uploaded at 23 April 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-11.jpg" title="Uploaded at 23 April 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 3 October 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-14.jpg" title="Uploaded at 3 October 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 3 October 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 7 November 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-13.jpg" title="Uploaded at 7 November 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 7 November 2020">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-14.jpg" title="Uploaded at 5 August 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-15.jpg" title="Uploaded at 5 August 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="img" class="tooltip rounded-full" src="dist/images/preview-13.jpg" title="Uploaded at 5 August 2020">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
