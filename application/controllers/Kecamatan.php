...
$this->load->view('parsial/head');
    ...
    public function update($id) 
    {
		...
		'camat' => set_value('camat', $row->camat),
...
$this->load->view('parsial/head');
	...
	$this->form_validation->set_rules('camat', 'camat', 'trim|required');
	...
	xlsWriteLabel($tablehead, $kolomhead++, "Camat");
	...
	foreach ($this->Kecamatan_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->camat);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2023-07-05 09:18:12 */
/* http://harviacode.com */